...
{
    public sealed class ChooseAnswerExercise: Exercise<ChooseAnswerExerciseData, CountRightExerciseResult>
    {
        public ChooseAnswerExercise(ExercisePresenters<ChooseAnswerExerciseData, CountRightExerciseResult> presenters, ChooseAnswerExerciseData exerciseData)
            : base(presenters, exerciseData, 
                new ResourcesExerciseRepository<ChooseAnswerExerciseData, CountRightExerciseResult>(exerciseData.ExerciseId))
        {
        }
        ...
        {
            var presenter = (ChooseAnswerExerciseWidget) Presenters.InProgressPresenter;
        ...
        private void ShowResultQuestions()
        {
            ...
            resultWidget.ShowChooseAnswerQuestions(questions);
        }
    }
}